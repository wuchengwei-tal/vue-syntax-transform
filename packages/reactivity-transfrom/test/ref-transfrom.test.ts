...
//     assertCode,
// } from "../../reactivity-transfrom/utils";

// import { BindingTypes } from "@vue/compiler-dom";
// import { parse } from "@vue/compiler-sfc";

// import { compileScript } from "../../reactivity-transfrom";
...
//     test("1", () => {
//         const { content, bindings } = transform(`<script setup>
...
//     //         compileWithReactivityTransform(`<script setup>
//     //   import { ref, shallowRef } from 'vue'
//     //   let foo = $(ref())
//     //   let a = $(ref(1))
//     //   let b = $(shallowRef({
...
//     //     expect(content).toMatch(
//     //         `{ foo, a, b, get c() { return c }, set c(v) { c = v }, ` +
